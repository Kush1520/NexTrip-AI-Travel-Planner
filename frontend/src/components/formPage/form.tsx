...
import { AlertCircle, ArrowRight, Sparkles, CalendarIcon } from "lucide-react";
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <Autocomplete
                            apiKey={import.meta.env.VITE_GOOGLE_API_KEY || "AIzaSyBIi9wqLiIi85sQEtA_JbVhiJlHo5t23o0"}
                            onPlaceSelected={(place) => {
                              if (place && place.formatted_address) {
                                handleChange("destination", place.formatted_address);
                              } else if (place && place.name) {
                                handleChange("destination", place.name);
                              }
                            }}
                            options={{
                              types: ["(regions)"],
                            ...
                            className="w-full bg-black/60 border border-blue-500/20 focus:border-purple-500/50 text-white h-12 sm:h-14 pl-10 text-sm sm:text-base lg:text-lg rounded-md"
                          />
