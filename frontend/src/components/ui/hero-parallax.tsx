  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex justify-center">
        ...
        >
          <motion.div 
            className="flex space-x-12 xs:space-x-6 sm:space-x-10 md:space-x-16 lg:space-x-20 mb-8 sm:mb-12 md:mb-16 lg:mb-20"
          ...
          <motion.div 
            className="flex mb-8 sm:mb-12 md:mb-16 lg:mb-20 space-x-8 xs:space-x-6 sm:space-x-10 md:space-x-16 lg:space-x-20"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: imagesLoaded && spotlightCompleted ? 1 : 0, y: imagesLoaded && spotlightCompleted ? 0 : 50 }}
          ...
          <motion.div 
            className="flex space-x-8 xs:space-x-6 sm:space-x-10 md:space-x-16 lg:space-x-20"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: imagesLoaded && spotlightCompleted ? 1 : 0, y: imagesLoaded && spotlightCompleted ? 0 : 50 }}
    ...
    <div className="absolute inset-0 w-full h-screen z-20 flex flex-col justify-center items-center pointer-events-none">
      ...
      >
        <div className="mb-4 sm:mb-6 md:mb-8 text-3xl font-bold tracking-tight sm:text-5xl md:text-6xl flex flex-col justify-center items-center text-center">
          {/* NexTrip text with proper styling */}
          <motion.div 
            className="mb-8"
